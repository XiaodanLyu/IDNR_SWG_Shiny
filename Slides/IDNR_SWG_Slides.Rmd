...
$$\boldsymbol{\phi}_t = \begin{bmatrix} 1-\epsilon_t & \epsilon_t \\ \gamma_t & 1-\gamma_t \end{bmatrix}, t = 1, ..., \text{T-1} $$
...
&= \psi_1(1-p_{1,1})p_{1,2}(1-p_{1,3})\Big[(1-\epsilon_1)\prod_{j=1}^3(1-p_{2,j})+\epsilon_1\Big]
\end{aligned}
\end{small}
$$
...
[^1]: the 2009 Iowa Landcover file
